...
def format_loss_accuracy(test_results, ni_neurons, nj_neurons, nk_neurons, nl_neurons,
...
def output_loss_accuracy(test_results, ni_neurons, nj_neurons, nk_neurons, nl_neurons, epochs, batch_size, optimizer,
                         stats_dir):
...
def format_and_output_loss_accuracy(test_results, ni_neurons, nj_neurons, nk_neurons, nl_neurons, epochs, batch_size,
                                    optimizer, stats_dir):
    test_results = format_loss_accuracy(test_results, ni_neurons, nj_neurons, nk_neurons, nl_neurons, epochs,
                                        batch_size, optimizer, stats_dir)
