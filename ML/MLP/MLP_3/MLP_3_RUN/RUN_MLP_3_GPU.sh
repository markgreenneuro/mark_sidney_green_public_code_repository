...
#SBATCH --mem=59000
#SBATCH --job-name=mlp_3_gpu
#SBATCH --partition=partition-1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --output=/home/markgreenneuroscience_gmail_com/LOG/ML/MLP/MLP_3/MLP_3_RUN/mlp_3_gpu-%j.output
#SBATCH --error=/home/markgreenneuroscience_gmail_com/LOG/ML/MLP/MLP_3/MLP_3_RUN/mlp_3_gpu-%j.error
