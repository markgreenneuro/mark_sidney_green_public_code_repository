...
def output_summary_stats(reg_score, roc_auc, mse, bic, aic, penalty_term, c_term, multi_class_term,
    ...
    aic_df.columns = ['AIC']
    full_df = pd.concat([roc_auc_df, reg_score_df, mse_df, bic_df, aic_df], axis=1).T.reset_index()
