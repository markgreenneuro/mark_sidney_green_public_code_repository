...
#SBATCH --ntasks=1
#SBATCH --output=/home/markgreenneuroscience_gmail_com/LOG/TS_KF_TRANSFORMS/GENERATE_WAV_REGRESSORS/WAV_FD/wav_fd-%j.output
#SBATCH --error=/home/markgreenneuroscience_gmail_com/LOG/TS_KF_TRANSFORMS/GENERATE_WAV_REGRESSORS/WAV_FD/wav_fd-%j.error
