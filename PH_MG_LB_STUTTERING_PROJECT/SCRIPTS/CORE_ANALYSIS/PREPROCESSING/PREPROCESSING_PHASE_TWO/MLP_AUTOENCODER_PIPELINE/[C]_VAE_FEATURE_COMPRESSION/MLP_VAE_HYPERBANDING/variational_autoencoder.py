    ...
    def build(self):
        layers = [tfkl.InputLayer(input_shape=(1, self.dim_x)),
                  tfkl.Dense(self.dim_x,
                              activation=self.encoder_dim_one_activation, kernel_initializer=glorot_uniform_initializer(),
                  ...
                  tfkl.Dense(self.encoder_dim_two_num,
                              activation=self.encoder_dim_two_activation, kernel_initializer=glorot_uniform_initializer(),
                              dropout = self.encoder_dim_two_dropout,
                              bias_initializer='zeros'),
                  tfkl.BatchNormalization(axis=1, momentum=0.1, epsilon=0.001),
                  tfkl.Dense(self.encoder_dim_three_num,
                             activation = self.encoder_dim_three_activation, kernel_initializer=glorot_uniform_initializer(),
                             dropout = self.encoder_dim_three_dropout,
                             bias_initializer='zeros'),
                  tfkl.BatchNormalization(axis=1, momentum=0.1, epsilon=0.001),
                  tfkl.Dense(self.encoder_dim_four_num,
                             activation = self.encoder_dim_four_activation, kernel_initializer=glorot_uniform_initializer(),
