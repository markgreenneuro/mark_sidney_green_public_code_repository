...
class ConductSklearnStandardScaling:
    def __init__(self, instantiate_data, *args, **kwargs):
        ...
        self.seed_value = instantiate_data.seed_value
        self.num_cats = instantiate_data.num_cats
        self.dim_x = instantiate_data.dim_x
        self.xtrain=instantiate_data.xtrain
        self.xtest=instantiate_data.xtest
        self.ytrain=instantiate_data.ytrain
        self.ytest=instantiate_data.ytest
        self.standardise()
