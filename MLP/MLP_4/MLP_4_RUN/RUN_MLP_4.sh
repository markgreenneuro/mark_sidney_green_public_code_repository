...
#SBATCH -c 6
#SBATCH --mem=59000
#SBATCH --job-name=mlp_4
#SBATCH --partition=partition-1
#SBATCH --ntasks=1
#SBATCH --output=/home/markgreenneuroscience_gmail_com/LOG/ML/MLP/MLP_4/MLP_4_RUN/mlp_4-%j.output
#SBATCH --error=/home/markgreenneuroscience_gmail_com/LOG/ML/MLP/MLP_4/MLP_4_RUN/mlp_4-%j.error
